...
def DispRMSEStats(Err,Truth,Prior,E):  
    ...
    print(['Relative Error in A0:' +str(Err.RelErrA0)])
    print(['Relative Uncertainty in A0: ' +str(mean(E.stdA0Post.T/E.A0hat.T))])
    ...
    print('Average NRMS for Q posterior: %.3f' %mean(Err.QRelErrPost,0))

    print('Average relative Q uncertainty: %.3f' %mean(mean(E.QstdPost/E.QhatPost,0)) )# D.nR × D.nt
